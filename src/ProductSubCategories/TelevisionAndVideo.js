...
const TelevisionAndVideo = ({ addToCart, count }) => {
    ...
    useEffect(() => {
        axios.get("https://project-8-ecommerce-backend.onrender.com/products/televisionandvideo")
    ...
    return (
        <>
            ...
            <h4 className='headings'>TELEVISION AND VIDEO</h4>
